...
The goal is to create to clear, concise, principle-based legislation that fulfils each of the considerations above.
So, once we have a firm understanding of what those concerns are, then the next step is to learn about anything that currently exists
that fulfil those considerations and can be used as a template for principle-based legislation.The hope is that something currently
fulfills those considerations and become a basis for understanding how to create pragmatic and principle-based legislation.
