...
Historically, laws were written in a reactionary manner in order to prevent a clever crime from being repeated.
...
In effect, Crypto Policy DAO was created to provide context and content to the web3 legislative process and landscape. We dont need
legislation that was created in reaction to a few bad actors because that creates a skewed perception and reality of crypto and
legislative process. We need to be proactive and provide web3-friendly regulation that promotes innovation while protecting the consumer.
